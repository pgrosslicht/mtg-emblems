...
(function() {
  var embleme, embleme2, get_emblem, get_emblem2, parse_mana, reset_emblems, shuffle;
  ...
  parse_mana = function(html) {
    html = html.replace(/\{([0-9BWRUGPSTQXYZ]+)\}/g, function(match, match2) {
  ...
  get_emblem = function() {
    ...
    return $('#anzahl').text(parseInt($('#anzahl').text()) + 1);
  };

  get_emblem2 = function() {
    var emblem;
  ...
  reset_emblems = function() {
    embleme2 = embleme.slice(0);
    $('#embleme').hide('slow').html('');
    return $('#anzahl').text('0');
  };
